...
//                 key={index}
//               >
//                 <div className="p-3 m-2 d-flex pl-5 list-item" onClick={() => {setShowBuyOptions(false), setShowRentOptions(false), toggleDrawer("add", false), setState(false) }}>
//                   <div
//                     className="list-item-text pl-3"
...
//             ))}
//           <div className="p-3 m-2 d-flex pl-4 list-item">
//             <div className="list-item-text pl-3" onClick={() => {setShowRentOptions(!showRentOptions) }}>Rent</div>
//             <div onClick={() => {setShowRentOptions(!showRentOptions)}}>
//                 <IconChevronDown />
//             </div>
//           </div>
//           {showRentOptions &&
...
//                       <MenuItem onClick={handleClose}>Popular Choices</MenuItem>
//                       <Divider />

//                           <MenuItem className="on-hover" onClick={handleClose}>
//                             Owner Properties
//                           </MenuItem>
//                           <MenuItem className="on-hover" onClick={handleClose}>
//                             Budget Homes
...
//                 <Link to="/allproperties" className="ml-0">
