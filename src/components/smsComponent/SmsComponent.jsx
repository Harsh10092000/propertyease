...
//   };
  ...
  const handleClick = () => {
      ...
      var url = 'https://api.textlocal.in/send/?apikey=NTYzNjcxNmM0OTY1NGM3MzQ4NzA1MDRmMzI2ZjcwNGE=&numbers=917404302678&sender=PR8PEZ&message=OTPtologintoapps123456';
      axios
        .get(url)
