                      ...
                      <div class="card ">
                        ...
                        <div className="profile-page-btns">
                          <div className="view-profile-button">
                            <Link to={`/agentProfile/${formatString(agentData.agent_name)}-in-${formatString(agentData.agent_sub_district)}-${formatString(agentData.agent_city)}-${formatString(agentData.agent_state)}-${userId}`}>
