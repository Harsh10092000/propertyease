...
//   //const { control, handleSubmit1 } = useForm({
//     const { control, setValue } = useForm({
//     defaultValues: {
//       tags: initialSelectedValues,
//     },
//   });
...
//                       >
//                         {item.name}
//                         <span><IconX className="ml-2" width={16} height={16} /></span>
//                       </div>
//                     ))}
//                   </div>
//                   {formSubmit === true && userData.user_exp === "" && (
...
//                 <div className="w-100 m-1 mb-3">
//                   <div className="d-flex flex-wrap ">
//                     {userData.user_work_city.map((item) => (
//                       <div
//                         className="pro_radio_btn_1 pro_selected"
...
//                 <div className="w-100 m-1 mb-3">
//                   <div className="d-flex flex-wrap ">
//                     {userData.user_work_sub_district.map((item) => (
//                       <div
//                         className="pro_radio_btn_1 pro_selected"
