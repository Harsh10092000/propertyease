                ...
                <div className="row">
                  ...
                  >
                    <div
                      ...
                      style={{ gap: "0" }}
                    >
                    { !skeleton? <h1 className="capitalize  pl-md-0 d-flex gap-3 align-items-center">
                        {data.pro_area_size +
                          " " +
                        ...
                        {currentUser ? (
                          ...
                          <Skeleton variant="rectangular" width={450} height={28}/>
                    }
                    </div>
                    {!skeleton?<div className="property-top-address pl-3 pl-md-0 pb-0 text-capitalize">
                      {data.pro_locality + ", " + data.pro_city}
                    </div>:
                    <Skeleton variant="rectangular" width={250} height={19} className="mt-1"/>
                  }
                    { !skeleton ?<span className="listed pl-3 pl-md-0 ">
                    ...
                    <Skeleton variant="rectangular" width={250} height={14} className="mt-1"/>
                  }
                    <div className="d-flex align-items-center justify-content-between p-1">
                      {!skeleton ?<div className="d-flex align-items-center justify-content-between pl-md-0">
                        <div className="property-price">
                          {data.pro_amt ? "₹" + data.pro_amt + " " + data.pro_amt_unit : "Ask Price"}
                        </div>
                      </div>:
                      <Skeleton variant="rectangular" width={150} height={40} className="mt-1"/>
                    }
                      ...
                      <div className="d-flex gap-2 align-items-center">
                        ...
                        <button className="fb" title="Share On Facebook">
                          ...
                          >
                            <IconBrandFacebook />
                            <span className="mobile-hidden" style={{fontWeight:"bold"}}>Share</span>
                          </a>
                        </button>
