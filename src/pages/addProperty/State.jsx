...
export const stateList = [
    {"id":"2","name":"Andaman and Nicobar Island (UT)"},
    ...
    {"id":"9","name":"Dadra and Nagar Haveli (UT)"},
    {"id":"10","name":"Daman and Diu (UT)"},
    {"id":"11","name":"Delhi (NCT)"},
    {"id":"12","name":"Goa"},
    {"id":"13","name":"Gujarat"},
    {"id":"14","name":"Haryana"},
    {"id":"15","name":"Himachal Pradesh"},
    {"id":"16","name":"Jammu and Kashmir(UT)"},
    {"id":"17","name":"Jharkhand"},
    {"id":"18","name":"Karnataka"},
    {"id":"19","name":"Kerala"},
    {"id":"20","name":"Ladakh(UT)"},
    {"id":"21","name":"Lakshadweep (UT)"},
