...
//               {/* <div className="row">
//                 {proListingPlan.map((item) => (
//                   <div className="col-md-4">
//                     <div>plan Name : {item.pro_plan_name}</div>
//                     <div>Amount : {item.pro_plan_amt}</div>
//                     <div>Validity : {item.pro_plan_validity}</div>
//                     <div>Add {item.pro_plan_property_slots} Properties</div>
//                     <button onClick={()=>handleBuy(item)} className="btn btn-primary">Buy Plan</button>
//                   </div>
//                 ))}
//               </div> */}
//               {/* <div>
...
//                   handleBuy={handleBuy}
//                 />
//                 {/* // <div className="col-md-4 plan-wrapper">
//                   //   <div className="plan-name">{item.pro_plan_name}</div>
//                   //   <div className="plan-price">₹{item.pro_plan_amt}/-</div>
//                   //   <div className="plan-validity">{item.pro_plan_validity}</div>
//                   //   <div>Add {item.pro_plan_property_slots} Properties</div>
//                   //   <button onClick={()=>handleBuy(item)} className="btn btn-primary">Buy Plan</button>
//                   // </div>
//                 ))} */}
...
const AddProperty = () => {
  ...
  //console.log("step2Disabled : ", step2Disabled);
  // useEffect(() => {
  //   if (step2) {
  //     if (
  //       propertyData.pro_type !== "" &&
